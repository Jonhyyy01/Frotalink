...
$stmt = $conn->prepare('SELECT nome_completo FROM motoristas WHERE id = ? LIMIT 1');
...
<head>
    ...
    <title>Apagar Motorista - Frotalink</title>
    ...
    <header class="topbar">
        <div class="brand">
            ...
            <div>
                ...
                <span class="brand-subtitle">Apagar Motorista</span>
            </div>
        </div>
    ...
    <div class="page-layout">
        ...
        <main class="dashboard-content">
            <section class="widget">
                ...
                <p>Tem certeza que deseja apagar o motorista:</p>
                <p><strong><?php echo htmlspecialchars($nome_completo); ?></strong></p>
                <form method="post" action="motoristas_apagar.php?id=<?php echo urlencode($id); ?>">
                    <button type="submit" class="button danger">Sim, apagar</button>
                    <a class="button secondary" href="motoristas_listar.php">Cancelar</a>
                </form>
            </section>
        </main>
    </div>
